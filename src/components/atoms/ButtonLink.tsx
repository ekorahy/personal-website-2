...
export default function ButtonLink({ title, route, variant }: ButtonLinkProps) {
  ...
  switch (variant) {
    case "primary":
      buttonStyles =
        "bg-amber-400 rounded-full px-4 py-2 text-xl lg:text-lg gap-2";
      break;
    case "secondary":
      buttonStyles =
        "bg-zinc-950 text-zinc-50 dark:bg-zinc-50 dark:text-zinc-950 rounded-full px-4 py-2 text-xl lg:text-lg gap-2";
      break;
    case "tertiary":
      buttonStyles =
        "bg-zinc-100 dark:bg-zinc-900 rounded-full px-4 py-2 text-xl lg:text-lg gap-2";
      break;
    case "paragraf":
      buttonStyles =
